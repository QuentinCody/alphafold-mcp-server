...
import { AlphafoldDataDO } from "./do";

// Export Durable Object classes
export { AlphafoldDataDO };

interface AlphafoldEnv {
...
export class MyMCP extends StatelessMcpWorker {
    ...
    async init() {
        ...
        const env = this.env as unknown as AlphafoldEnv;
...
export default {
    fetch(request: Request, env: Env, ctx: ExecutionContext) {
        ...
        if (url.pathname === "/health") {
            return buildHealthResponse("alphafold");
        }
        ...
        if (url.pathname === "/readyz") {
            ...
            return MyMCP.readiness(env, "alphafold");
        }
